...
public class GlobalControllerAdvice {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    public ErrorResponse<Violation> onMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e) {
        ErrorResponse<Violation> error = new ErrorResponse<>(new ArrayList<>());
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    public ErrorResponse<ImmutablePair<String, String>> onBadRequestException(BadRequestException e) {
    ...
    @ResponseBody
    public ErrorResponse<ImmutablePair<String, String>> onRuntimeException(RuntimeException e) {
        ErrorResponse<ImmutablePair<String, String>> error = new ErrorResponse<>(new ArrayList<>());
        error.errors().add(new ImmutablePair<>("message", e.getMessage()));
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    public ErrorResponse<Violation> onMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ErrorResponse<Violation> error = new ErrorResponse<>(new ArrayList<>());
        error.errors().add(new Violation(e.getParameter().getParameterName(), e.getMessage()));
        log.error("method argument mismatch : ", e);
        return error;
